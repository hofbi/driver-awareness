...
vehicle traveling in the opposite direction. Additionally there is a pedestrian.
"""
...
class ManeuverOppositeDirectionPedestrian(BasicScenario):
    """
    ...
    def __init__(
        ...
        self._blackboard_queue_name = (
            "ManeuverOppositeDirectionPedestrian/actor_flow_queue"
        )
    ...
    def _create_behavior(self):
        ...
        pedestrian_walking = KeepVelocity(self.other_actors[2], 1, distance=300)
